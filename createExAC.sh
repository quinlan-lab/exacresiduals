...
vt decompose $DATA/gnomad.exomes.r2.0.1.sites.vcf.gz -o $DATA/gnomad.exomes.r2.0.1.sites.dec.vcf
vt normalize $DATA/gnomad.exomes.r2.0.1.sites.dec.vcf -o $DATA/gnomad.exomes.r2.0.1.sites.vt.vcf -r $DATA/grch37.fa
perl $HOME/software/ensembl-tools-release-81/scripts/variant_effect_predictor/variant_effect_predictor.pl -i $DATA/gnomad.exomes.r2.0.1.sites.vt.vcf --cache --sift b --polyphen b --symbol --numbers --biotype --allele_number -o $DATA/gnomad.exomes.r2.0.1.sites.vep.vt.vcf --vcf --fields ALLELE,Consequence,Codons,Amino_acids,Gene,SYMBOL,Feature,EXON,PolyPhen,SIFT,Protein_position,BIOTYPE,ALLELE_NUM,cDNA_position --offline --fork 8 --force_overwrite
bgzip $DATA/gnomad.exomes.r2.0.1.sites.vep.vt.vcf
tabix $DATA/gnomad.exomes.r2.0.1.sites.vep.vt.vcf.gz

# old ExAC
vt decompose $DATA/ExAC.r0.3.sites.vep.vcf.gz -o $DATA/ExAC.r0.3.sites.dec.vcf
vt normalize $DATA/ExAC.r0.3.sites.dec.vcf -o $DATA/ExAC.r0.3.sites.vt.vcf -r $DATA/grch37.fa
perl $HOME/software/ensembl-tools-release-81/scripts/variant_effect_predictor/variant_effect_predictor.pl -i $DATA/ExAC.r0.3.sites.vt.vcf --cache --sift b --polyphen b --symbol --numbers --biotype --allele_number -o $DATA/ExAC.r0.3.sites.vt.vep.vcf --vcf --fields ALLELE,Consequence,Codons,Amino_acids,Gene,SYMBOL,Feature,EXON,PolyPhen,SIFT,Protein_position,BIOTYPE,ALLELE_NUM,cDNA_position --offline --fork 8 --force_overwrite
