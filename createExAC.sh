...
perl $HOME/software/ensembl-tools-release-81/scripts/variant_effect_predictor/variant_effect_predictor.pl -i /tmp/ExAC.r0.3.sites.vt.vcf --cache --sift b --polyphen b --symbol --numbers --biotype --allele_number -o $DATA/ExAC.r0.3.sites.vt.vep.vcf --vcf --fields ALLELE,Consequence,Codons,Amino_acids,Gene,SYMBOL,Feature,EXON,PolyPhen,SIFT,Protein_position,BIOTYPE,ALLELE_NUM,cDNA_position --offline --fork 8
